...
export class CustomerProfilePage {
  ...
  constructor(
    ...
    console.log("CustomerProfilePage constructor");
  ...
  //Used to navigate to customer bank page
  addBankDetails() {
    this.navCtrl.push(CustomerBankDetailsPage);
  }

  //used to set root to customer address page
  addAddress() {
    this.navCtrl.setRoot(CustomerAddressPage);
  }

  //used to get the customer profile 
  doProfile() {
